...
import 'package:app/services/GetMonthBills.dart';
...
class MonthBills extends StatefulWidget {
  @override
  _TodayBillsState createState() => _TodayBillsState();
}

class _TodayBillsState extends State<MonthBills> {
  List<Bill> bills = [
  ...
  void updateBills(date) async {
    if (date != null) {
      bool res = await GetMonthBills.getMonthBills(date);
      if (res) {
        setState(() {
          bills = GetMonthBills.bills;
          total = GetMonthBills.total;
          loading = false;
        });
      } else {
        setState(() {
                      ...
                      Padding(
                        ...
                        child: Text(
                          dateSelected == null
                              ...
                              : DateFormat('yyyy-MM').format(dateSelected),
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 22,
